...
module zmotorholder(thickness=13){
    difference(){
        union(){
            ...
            difference(){
                union(){
                    zrodholder(thickness=thickness, xlen=45, ylen=35+board_thickness);
...
module zrodholder(thickness=13, ylen=20+board_thickness, xlen=34){
    difference(){
        union(){
            // Rod holding part
            difference(){
...
translate([21,-56,0]) zrodholder();
translate([20,56,0]) mirror([0,1,0]) zrodholder();
